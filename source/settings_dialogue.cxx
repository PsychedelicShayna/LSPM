#include "headers/settings_dialogue.hxx"
...
void SettingsDialogue::on_pushButton_SaveSettings_clicked() {
    std::ofstream output_stream("lspm_config.json", std::ios::binary);
    ...
    if(output_stream.good()) {
        ...
        messagebox_error->setText("Cannot open lspm_config.json for writing, the stream wasn't good.");
