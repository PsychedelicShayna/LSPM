...
void PasswordGeneratorDialogue::on_pushButton_Generate_clicked() {
    ...
    this->ui_->plainTextEdit_Password->setPlainText(generated_password);
}
...
PasswordGeneratorDialogue::PasswordGeneratorDialogue(QWidget* parent) : QDialog(parent), ui_(new Ui::PasswordGeneratorDialogue) {
    ui_->setupUi(this);
